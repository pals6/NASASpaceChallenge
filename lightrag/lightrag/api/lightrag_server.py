...
from lightrag.api.routers.podast_routes import create_podcast_routes
from lightrag.api.routers.comic_routes import create_comic_routes
...
def create_app(args):
    ...
    app.include_router(create_podcast_routes(rag, api_key))
    app.include_router(create_comic_routes(rag, api_key))
